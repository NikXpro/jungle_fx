Citizen.CreateThread(function()
	if not IsIplActive("k4mb1_artgallery_milo_") then RequestIpl("k4mb1_artgallery_milo_");
	PinInteriorInMemory("k4mb1_artgallery_milo_")
-- Vault
	local interiorid = GetInteriorAtCoords(27.479, 143.0221, 97.944)
