				...
				if GetPedInVehicleSeat(veh, -1) == playerped then
					...
					if GetVehicleClass(veh) == 18 then
						...
						if not IsPauseMenuActive() then
							...
							-- Center Out
							elseif IsControlJustPressed(1, TACenter) or IsDisabledControlJustPressed(1, TACenter) then
								if IsVehicleExtraTurnedOn(GetVehiclePedIsUsing(GetPlayerPed(-1), false), 10) then
									...
									if checkeroni == 'pd' then SetVehicleExtra(GetVehiclePedIsUsing(GetPlayerPed(-1), false), 9, true) end
									SetVehicleExtra(GetVehiclePedIsUsing(GetPlayerPed(-1), false), 8, false)
									TriggerEvent("lux_vehcontrol:ELSClick", "On", 0.5)
								end
					
							-- Left to Right
							elseif IsControlJustPressed(1, TARight) or IsDisabledControlJustPressed(1, TARight) then
							...
							-- Right to Left
							elseif IsControlJustPressed(1, TALeft) or IsDisabledControlJustPressed(1, TALeft) then
							...
							-- On Scene Lighting
							elseif IsControlJustPressed(1, SceneLights) or IsDisabledControlJustPressed(1, SceneLights) then
								local existo = DoesExtraExist(GetVehiclePedIsUsing(GetPlayerPed(-1), false), 9)
								if checkeroni == 'pd' and DoesExtraExist(GetVehiclePedIsUsing(GetPlayerPed(-1), false), 9) then
									if IsVehicleExtraTurnedOn(GetVehiclePedIsUsing(GetPlayerPed(-1), false), 9) then
										...
										TriggerEvent("lux_vehcontrol:ELSClick", "Upgrade", 0.5)
									end	
								end	
