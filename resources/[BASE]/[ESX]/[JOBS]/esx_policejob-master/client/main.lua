				...
				if closestPlayer ~= -1 and closestDistance <= 3.0 then
					...
					elseif action == 'ppa' then
						...
						if closestPlayer ~= -1 and closestDistance <= 3.0 then
							...
							TriggerServerEvent('esx_license:addLicense', GetPlayerServerId(closestPlayer), 'ppa_2')
						else
...
Citizen.CreateThread(function()
	while true do
		if ESX.PlayerData.job and ESX.PlayerData.job.name == ('police' or 'ambulance') then
