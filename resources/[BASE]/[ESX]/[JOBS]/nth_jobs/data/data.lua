...
data.jobMenu = {
    ...
    UNICONRfrigo = {
        ...
        Settings = {
            ...
            TailleZone = 1.5,
            blip = { Activate = true, property = false, BlipId = 121, BlipScale = 0.8, BlipColor = 83, BlipName = "Unicorn" },
    ...
    UNICONRcoffre = {
        ...
        Settings = {
            ...
            TailleZone = 1.5,
            blip = { Activate = false, property = false, BlipId = 52, BlipScale = 0.8, BlipColor = 1, BlipName = "Unicorn" },
            ped = { Activate = false, PedHash = "csb_trafficwarden", Heanding = 39.84715270996094 },
            marker = { Activate = false, MarkerType = 1, MarkerColor = {r = 50, g = 50, b = 204}, MarkerSize = {x = 1.5, y = 1.5, z = 0.5}, ViewDistance = 3.0 },
        },
