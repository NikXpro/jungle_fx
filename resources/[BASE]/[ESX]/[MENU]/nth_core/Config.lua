...
-- Ammo
Config.number_cal_12 = 8 -- (Shotgun Ammo)
Config.number_9mm = 10 -- (Pistol Ammo)
Config.number_5_56mm = 30 -- (Assualt Rifles Ammo)
Config.number_7_62mm = 20 -- (Submachine Gun Ammo)
...
Config.kBank = {
  ...
  {x = -386.733, y = 6045.953, z = 31.501},
	...
	{x = 903.69573974609, y = -164.17553710938, z = 73.168395996094}
}
-- Blips banque fin