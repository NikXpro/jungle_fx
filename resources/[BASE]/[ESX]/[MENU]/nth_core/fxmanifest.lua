...
client_scripts {
    ...
    '_data/data.lua',
    '_core/_menu/client/client.lua',
    '_core/_menu/client/function.lua',
    '_core/_menu/client/zone_shop.lua',
    '_core/_interaction/client/client.lua',
    '_core/_interaction/client/function.lua',
    '_core/_jobs/client/client.lua',
    '_core/_ammo/client/c_ammo.lua',
    'Config.lua'
}
...
server_scripts {
  ...
  '_data/data.lua.lua',
  '_data/_data-server/data_shop.lua',
  '_core/_menu/server/request_banque.lua',
  '_core/_menu/server/request_service.lua',
  '_core/_interaction/server/server.lua',
  '_core/_jobs/server/server.lua',
  '_core/_ammo/server/s_ammo.lua',
  'Config.lua'
}
